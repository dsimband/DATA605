...
f <- function(x){return(4 * exp(-7*x))}

curve(f, from = -4, to = 4, type="l", main = 'Graphs', col = 'blue')
...
g <- function(x){return(0.5 * cos(2*x) -1)}
curve(f, from = -2, to = 3, type="l", main = 'Graphs', col = 'blue', ylim=c(-5,5))
curve(g, from = -2, to = 3, type="l", col = 'red', add=TRUE)

area.f <- integrate(f, lower = 0, upper = 4*pi)
area.g <- integrate(g, lower = 0, upper = 4*pi)
...
f <- function(x){return(2 * x - 4)}
curve(f, from = -5, to = 10, type="l", main = 'Graphs', col = 'blue')

area.f <- integrate(f, lower = -2, upper = 5)
area.f$value
